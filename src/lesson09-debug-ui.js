...
const customTweaks = customGui.addFolder('Test Tweaks');
...
// Object to handle properies for debug ui/tweak
const debugObject = {};
debugObject.color = new THREE.Color('#a778d8');
...
const RenderGeometry = () =>
{
    ...
    .onChange(() =>
    {
        console.log(debugObject.color.getHexString());
        mesh.material.color = debugObject.color;
    });
